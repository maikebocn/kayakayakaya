		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by <a href="http://yoast.com/">Yoast</a>'s <a href="http://yoast.com/xml-sitemap-php-script/">XML Sitemap PHP Script</a>, this is an XML Sitemap, meant for consumption by search engines.
					</p>
					<p class="expl">
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="/sitemap-index.xml">sitemap index</a><br/><br/>
						<a href="/imagesitemap-index.xml">image sitemap index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
									<th width="80%">URL</th>
